...
class Planet {
    constructor() {
        ...
        if (sizeCategory < 0.2) {
            // Giant planets (20% chance)
            this.size = random(80, 120);
        } else if (sizeCategory < 0.5) {
            // Medium planets (30% chance)
            this.size = random(50, 80);
        } else if (sizeCategory < 0.8) {
            // Small planets (30% chance)
            this.size = random(30, 50);
        } else {
            // Dwarf planets (20% chance)
        ...
        this.orbitRadius = random(50, 150);
        this.orbitAngle = random(TWO_PI);
        this.orbitSpeed = random(0.0005, 0.001);
        this.moons = [];
        
        // Add random moons based on planet size
        let numMoons = floor(map(this.size, 15, 120, 0, 4));
...
function drawGalaxyBackground() {
    ...
    let c1 = color(5, 0, 15);  // Darker space blue
...
function setup() {
    ...
    // Initialize planets in a more organized pattern
    for (let i = 0; i < 5; i++) {
